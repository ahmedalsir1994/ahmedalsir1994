<h1 align="left">Hey 👋 I'm Ahmed</h1>
...
<p align="left">🔧 Experienced in building web applications using Laravel and PHP  <br>🌐 Skilled in developing custom WordPress websites  <br>⚡ Building CMS systems and admin dashboards  <br>🔐 Developing RESTful APIs with authentication & authorization  <br>🚀 Improving performance using caching and optimization techniques<br> 💳 Integrating payment gateways <br>📱 Exploring mobile app development using Flutter</p>
...
<p align="left">💻 Backend  <br>`Laravel` `PHP` `MySQL` `REST API`  <br><br>🎨 Frontend  <br>`HTML` `CSS` `Bootstrap` `Tailwind CSS` `JavaScript` `React`  <br><br>🔐 Security & Auth  <br>`Laravel Sanctum` `API Tokens` `Authentication` `Authorization` `Policies`  <br><br>⚡ Performance & Optimization  <br>`Caching` `Query Optimization` `Lazy Loading` `Queue Jobs`  <br><br>⚙️ Tools & Platforms  <br>`WordPress` `Git` `AWS` `Google Cloud</p>
